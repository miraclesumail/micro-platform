...
export default function Travel({ store }: any) {
  ...
  return (
    <div className='container'>
      <h2 onClick={() => store.dispatch({ user: 'aiaiaia' })}>travel app</h2>
...
export function Mall() {
  return <div>this is dev travel</div>;
}
